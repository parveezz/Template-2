...
<div className="py-16">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={idx} className="border border-border bg-surface p-6 transition-colors hover:border-brand">
                <span className="mb-3 inline-block font-sans text-[10px] font-semibold uppercase tracking-[2px] text-text-muted">
                  {job.type}
                </span>
                <h3 className="mb-2 font-sans text-[20px] font-medium text-text-main">{job.title}</h3>
                <p className="mb-6 font-sans text-[13px] text-text-muted">{job.location}</p>
